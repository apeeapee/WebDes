        ...
        <MainLayout>
            ...
            <div class="relative overflow-hidden bg-slate-950 text-white min-h-[380px] sm:min-h-[540px] flex flex-col justify-center">
                ...
                <div class="relative mx-auto max-w-7xl px-4 py-16 sm:py-24 sm:px-6 lg:px-8 flex flex-col items-center text-center z-20">
                    ...
                    <p class="mt-4 sm:mt-6 text-sm sm:text-lg text-white font-medium max-w-3xl leading-relaxed drop-shadow-[0_2px_10px_rgba(0,0,0,0.95)]">
            ...
            <div class="relative z-10 -mt-8 sm:-mt-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 rounded-2xl bg-white p-4 sm:p-6 shadow-2xl border border-sky-100/80 backdrop-blur-lg">
                    <div class="flex flex-col items-center justify-center p-2 sm:p-4 text-center">
                        <div class="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-2xl bg-sky-50 text-sky-600 mb-2 sm:mb-3 shadow-xs">
                            <Users class="h-5 w-5 sm:h-6 sm:w-6" />
                        </div>
                        <span class="text-xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">{(stats?.penduduk ?? 3420).toLocaleString('id-ID')}</span>
                        <span class="text-[10px] sm:text-xs font-bold text-sky-700 uppercase mt-1 tracking-wider">Total Warga</span>
                    </div>
                    
                    <div class="flex flex-col items-center justify-center p-2 sm:p-4 text-center">
                        <div class="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-2xl bg-blue-50 text-blue-600 mb-2 sm:mb-3 shadow-xs">
                            <HomeIcon class="h-5 w-5 sm:h-6 sm:w-6" />
                        </div>
                        <span class="text-xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">{(stats?.kk ?? 985).toLocaleString('id-ID')}</span>
                        <span class="text-[10px] sm:text-xs font-bold text-blue-700 uppercase mt-1 tracking-wider">Kepala Keluarga</span>
                    </div>
                    
                    <div class="flex flex-col items-center justify-center p-2 sm:p-4 text-center">
                        <div class="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-2xl bg-cyan-50 text-cyan-600 mb-2 sm:mb-3 shadow-xs">
                            <Sprout class="h-5 w-5 sm:h-6 sm:w-6" />
                        </div>
                        <span class="text-xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">{stats?.luas_tani || '245 Ha'}</span>
                        <span class="text-[10px] sm:text-xs font-bold text-cyan-700 uppercase mt-1 tracking-wider">Luas Lahan</span>
                    </div>
                    
                    <div class="flex flex-col items-center justify-center p-2 sm:p-4 text-center">
                        <div class="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-2xl bg-indigo-50 text-indigo-600 mb-2 sm:mb-3 shadow-xs">
                            <ShoppingBag class="h-5 w-5 sm:h-6 sm:w-6" />
                        </div>
                        <span class="text-xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">{stats?.umkm || 8}</span>
                        <span class="text-[10px] sm:text-xs font-bold text-indigo-700 uppercase mt-1 tracking-wider">UMKM Binaan</span>
                    </div>
                    
                    <div class="col-span-2 sm:col-span-1 flex flex-col items-center justify-center p-2 sm:p-4 text-center">
                        <div class="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-2xl bg-rose-50 text-rose-600 mb-2 sm:mb-3 shadow-xs">
                            <Activity class="h-5 w-5 sm:h-6 sm:w-6" />
                        </div>
                        <span class="text-xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">{stats?.posyandu || 5}</span>
                        <span class="text-[10px] sm:text-xs font-bold text-rose-700 uppercase mt-1 tracking-wider">Posyandu Aktif</span>
                    </div>
                </div>
            </div>
            ...
            <div class="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
                <div class="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 class="mt-3 text-2xl sm:text-3xl font-extrabold text-slate-900 lg:text-4xl leading-tight">Portal Integrasi Layanan Desa</h2>
                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex flex-col md:flex-row md:items-end justify-between mb-12">
                        <div>
                            ...
                            <h2 class="mt-3 text-2xl sm:text-3xl font-extrabold text-slate-900 leading-tight lg:text-4xl">Warta Kegiatan Banyuurip</h2>
                        </div>
                    </div>
            ...
            <div class="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <h2 class="mt-3 text-2xl sm:text-3xl font-extrabold text-slate-900 leading-tight lg:text-4xl">Desa Banyuurip, Klego</h2>
                        <p class="mt-4 text-slate-600 leading-relaxed">
                    ...
                    <div class="relative rounded-2xl bg-gradient-to-br from-sky-900 to-blue-900 p-4 sm:p-6 shadow-2xl border border-sky-400/30 overflow-hidden h-[280px] sm:h-[360px] flex items-center justify-center text-white">
